...
- Current phase focus has shifted from projected hardening to compact model capacity:
  ...
  - next high-value build step is radial calibration / angular-radial decoupling for signed prediction geometry while preserving health/spread before bounce, depthwise convolution, spatial predictor work, or more objective tuning,
